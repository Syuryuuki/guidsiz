...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.syuryuuki.guidsiz.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.syuryuuki.guidsiz")
    #endif
