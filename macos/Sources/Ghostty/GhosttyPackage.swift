...
extension Ghostty {
    ...
    static let userNotificationCategory = "com.syuryuuki.guidsiz.userNotification"

    // The user notification "Show" action
    static let userNotificationActionShow = "com.syuryuuki.guidsiz.userNotification.Show"
}
...
extension Notification.Name {
    ...
    static let ghosttyConfigDidChange = Notification.Name("com.syuryuuki.guidsiz.configDidChange")
    static let GhosttyConfigChangeKey = ghosttyConfigDidChange.rawValue

    /// Color change. Object is the surface changing.
    static let ghosttyColorDidChange = Notification.Name("com.syuryuuki.guidsiz.ghosttyColorDidChange")
    static let GhosttyColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("com.syuryuuki.guidsiz.moveTab")
    static let GhosttyMoveTabKey = ghosttyMoveTab.rawValue

    /// Close tab
    static let ghosttyCloseTab = Notification.Name("com.syuryuuki.guidsiz.closeTab")

    /// Close other tabs
    static let ghosttyCloseOtherTabs = Notification.Name("com.syuryuuki.guidsiz.closeOtherTabs")

    /// Close tabs to the right of the focused tab
    static let ghosttyCloseTabsOnTheRight = Notification.Name("com.syuryuuki.guidsiz.closeTabsOnTheRight")

    /// Close window
    static let ghosttyCloseWindow = Notification.Name("com.syuryuuki.guidsiz.closeWindow")

    /// Resize the window to a default size.
    static let ghosttyResetWindowSize = Notification.Name("com.syuryuuki.guidsiz.resetWindowSize")

    /// Ring the bell
    static let ghosttyBellDidRing = Notification.Name("com.syuryuuki.guidsiz.ghosttyBellDidRing")

    /// Readonly mode changed
    static let ghosttyDidChangeReadonly = Notification.Name("com.syuryuuki.guidsiz.didChangeReadonly")
    static let ReadonlyKey = ghosttyDidChangeReadonly.rawValue + ".readonly"
    static let ghosttyCommandPaletteDidToggle = Notification.Name("com.syuryuuki.guidsiz.commandPaletteDidToggle")

    /// Toggle maximize of current window
    static let ghosttyMaximizeDidToggle = Notification.Name("com.syuryuuki.guidsiz.maximizeDidToggle")

    /// Notification sent when scrollbar updates
    static let ghosttyDidUpdateScrollbar = Notification.Name("com.syuryuuki.guidsiz.didUpdateScrollbar")
    static let ScrollbarKey = ghosttyDidUpdateScrollbar.rawValue + ".scrollbar"

    /// Focus the search field
    static let ghosttySearchFocus = Notification.Name("com.syuryuuki.guidsiz.searchFocus")
}
...
extension Ghostty.Notification {
    ...
    static let NewSurfaceConfigKey = "com.syuryuuki.guidsiz.newSurfaceConfig"

    /// Posted when a new split is requested. The sending object will be the surface that had focus. The
    /// userdata has one key "direction" with the direction to split to.
    static let ghosttyNewSplit = Notification.Name("com.syuryuuki.guidsiz.newSplit")

    /// Close the calling surface.
    static let ghosttyCloseSurface = Notification.Name("com.syuryuuki.guidsiz.closeSurface")

    /// Focus previous/next split. Has a SplitFocusDirection in the userinfo.
    static let ghosttyFocusSplit = Notification.Name("com.syuryuuki.guidsiz.focusSplit")
    static let SplitDirectionKey = ghosttyFocusSplit.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyGotoTab = Notification.Name("com.syuryuuki.guidsiz.gotoTab")
    static let GotoTabKey = ghosttyGotoTab.rawValue

    /// New tab. Has base surface config requested in userinfo.
    static let ghosttyNewTab = Notification.Name("com.syuryuuki.guidsiz.newTab")

    /// New window. Has base surface config requested in userinfo.
    static let ghosttyNewWindow = Notification.Name("com.syuryuuki.guidsiz.newWindow")

    /// Present terminal. Bring the surface's window to focus without activating the app.
    static let ghosttyPresentTerminal = Notification.Name("com.syuryuuki.guidsiz.presentTerminal")

    /// Toggle fullscreen of current window
    static let ghosttyToggleFullscreen = Notification.Name("com.syuryuuki.guidsiz.toggleFullscreen")
    static let FullscreenModeKey = ghosttyToggleFullscreen.rawValue

    /// Notification sent to toggle split maximize/unmaximize.
    static let didToggleSplitZoom = Notification.Name("com.syuryuuki.guidsiz.didToggleSplitZoom")

    /// Notification
    static let didReceiveInitialWindowFrame = Notification.Name("com.syuryuuki.guidsiz.didReceiveInitialWindowFrame")
    static let FrameKey = "com.syuryuuki.guidsiz.frame"

    /// Notification to render the inspector for a surface
    static let inspectorNeedsDisplay = Notification.Name("com.syuryuuki.guidsiz.inspectorNeedsDisplay")

    /// Notification to show/hide the inspector
    static let didControlInspector = Notification.Name("com.syuryuuki.guidsiz.didControlInspector")

    static let confirmClipboard = Notification.Name("com.syuryuuki.guidsiz.confirmClipboard")
    ...
    static let didResizeSplit = Notification.Name("com.syuryuuki.guidsiz.didResizeSplit")
    ...
    static let didEqualizeSplits = Notification.Name("com.syuryuuki.guidsiz.didEqualizeSplits")

    /// Notification that renderer health changed
    static let didUpdateRendererHealth = Notification.Name("com.syuryuuki.guidsiz.didUpdateRendererHealth")

    /// Notifications related to key sequences
    static let didContinueKeySequence = Notification.Name("com.syuryuuki.guidsiz.didContinueKeySequence")
    static let didEndKeySequence = Notification.Name("com.syuryuuki.guidsiz.didEndKeySequence")
    static let KeySequenceKey = didContinueKeySequence.rawValue + ".key"

    /// Notifications related to key tables
    static let didChangeKeyTable = Notification.Name("com.syuryuuki.guidsiz.didChangeKeyTable")
